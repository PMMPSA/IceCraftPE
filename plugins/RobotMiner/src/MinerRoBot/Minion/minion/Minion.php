...
class Minion extends Human{
    ...
    public function initEntity(): void{
        ...
        $this->minionname = $this->player . " §c✇ §e§lRobot Miner§r§c ✇";
        $this->setHealth(1);
        $this->setMaxHealth(1);
    ...
    public function attack(EntityDamageEvent $source): void{
        ...
        if($source instanceof EntityDamageByEntityEvent){
            ...
            if($damager instanceof Player){
                ...
                $pos = new Position(intval($damager->getX()), intval($damager->getY()) + 5, intval($damager->getZ()), $damager->getLevel());
    ...
    public function entityBaseTick(int $tickDiff = 1): bool{
        ...
        //random names
        if($this->getLevel()->getServer()->getTick() % 15 == 0){
    ...
    public function getMaxTime(): int{
        return (10 * Main::get()->getConfig()->getNested("level.max")) + 10;
    }

    public function getMineTime(): int{
        return $this->getMaxTime() - (10 * $this->namedtag->getInt("level"));
    }
