...
namespace MinerRoBot\Minion\minion;
...
class HopperInventory extends CustomInventory{
    ...
    public function getDestoryItem(): Item{
        ...
        $item->setCustomName(C::RED . "Thu Hồi Đệ Tử");
        return $item;
    }
    ...
    public function getChestItem(): Item{
        ...
        $item->setCustomName(C::DARK_GREEN . "✔Liên Kết Rương");
        $item->setLore([" ",  C::YELLOW . "✔Liên Kết: " . C::WHITE . $islinked, C::YELLOW . "Coordinates: " . C::WHITE . $this->entity->getChestCoordinates()]);
        return $item;
    }

    public function getLevelItem(): Item{
        $item = Item::get(Item::EMERALD);
        $item->setCustomName(C::LIGHT_PURPLE . "Cấp: " . C::YELLOW . $this->entity->getLevelM());
        $item->setLore([C::LIGHT_PURPLE . "Giá: " . C::YELLOW . "Point " . $this->entity->getCost()]);
        return $item;
    }
}