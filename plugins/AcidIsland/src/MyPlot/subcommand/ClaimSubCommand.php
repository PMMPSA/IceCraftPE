...
class ClaimSubCommand extends SubCommand
{
    ...
    public function execute(CommandSender $sender, array $args) {
        ...
        if ($this->getPlugin()->getProvider()->savePlot($plot)) {
            ...
            $sender->sendMessage("§b<[§aAcid§eIsland§b]> §eĐã Thêm§l§b Băng§e,§6 Dung Nham§e và§a Thức ăn§r§e Vào Kho Đồ Của Bạn");
			//$sender->sendMessage("§b<[§aAcid§eIsland§b]> §eBạn đã nhận được§b§l 1 Chú Bò§r§e! §cHãy suy nghĩ cẩn thận!");
			$sender->sendMessage("§b<[§aAcid§eIsland§b]> §eHãy cẩn thân! Nước chình là§l §dAcid§r§e đó!");
			/*$nbt = new CompoundTag ("", [ 
							"Pos" => new ListTag( "Pos", [ 
						...
						$mob = Entity::createEntity(Cow::NETWORK_ID, $sender->chunk, $nbt);
						$mob->setMaxHealth(20);
						$mob->setHealth(20);
						$mob->setNameTag("§a§l►§6 " . $plot->owner . "§b's Cow §a◄§r");
						$mob->spawnToAll();*/
        } else {
